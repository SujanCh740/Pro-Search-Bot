...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001952869963').split()]
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002551525608')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001826734158')
...
APP_URL = environ.get('APP_URL', 'https://confused-moose-filestorexbot-d7bb0c0a.koyeb.app') # Your bot app url
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/How_2_Download_From_TeraBox/5732')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001813638350'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '-1002551525608')
